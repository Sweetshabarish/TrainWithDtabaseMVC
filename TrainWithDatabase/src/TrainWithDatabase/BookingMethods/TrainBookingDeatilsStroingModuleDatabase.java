...
import TrainWithDatabase.DatabasePackage.UserStoreDetailsExecutiondatbase;
...
public class TrainBookingDeatilsStroingModuleDatabase {
    ...
    public TrainBookingDeatilsStroingModuleDatabase(boolean b) {
        if (b) {
            setName();
            setLocation();
            setDestination();
    ...
    static void methodForTrainBooking() throws SQLException {
        ...
        UserStoreDetailsExecutiondatbase.userStoreDetails(p);
    }
